...
I explored concurrency in Haskell using some examples from talk [Go Concurrency
Patterns][GoVersion] by Rob Pike.
...
program is gradually improved to become concurrent and better performing with
later iterations.
