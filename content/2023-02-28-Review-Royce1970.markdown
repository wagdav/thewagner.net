...
> _Allocate processing, functions, design the database, define database
...
> _Each and every worker must have an elemental understanding of the system.
...
> _The first rule of managing software development is ruthless enforcement of
...
> _If the computer program in question is being developed for the first time,
