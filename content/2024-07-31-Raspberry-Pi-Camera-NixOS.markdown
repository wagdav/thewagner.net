...
my Raspberry Pi 3 running NixOS.
...
The NixOS configuration block that enables the image sensor reads as follows:
...
And, of course, I can take pictures:
...
I'm trying to impress you with the image quality.  The v1 camera module was
[released in 2013][v1Release], the modules available today have much better
sensors and optics.
